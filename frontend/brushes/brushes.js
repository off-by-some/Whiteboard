...
var rgb2hsl, hsl2rgb, Brush, WireframeBrush, ColorSamplerBrush, Lenny, EraserBrush, CopyPasteBrush, SketchBrush, getBrush;
...
SketchBrush = (function(superclass){
  ...
  prototype.actionMove = function(x, y){
    ...
    if (numpoints > 1) {
      ...
      this.canvas.context.stroke();
      this.canvas.context.closePath();
      this.canvas.context.strokeStyle = "rgba(" + this.color[0] + "," + this.color[1] + "," + this.color[2] + "," + this.color[3] / 3.0 + ")";
